...
export class BtnGoogleComponent implements OnDestroy {
  ...
  constructor(
    ...
    this.authStatusSubscription = this.authService.isAuthenticating$.subscribe(
      (status) => (this.isAuthenticating = status),
    );
  }
